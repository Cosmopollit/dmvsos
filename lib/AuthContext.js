...
const AuthContext = createContext({ user: null, isPro: false, hasMoto: false, hasCdl: false, planType: null, planExpiresAt: null, loading: true });
...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider value={{ user, isPro, hasMoto, hasCdl, planType, planExpiresAt, loading }}>
      {children}
