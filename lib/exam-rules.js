...
export const STATE_EXAM_RULES = {
  ...
  california:     { car: { questions: 46, pass: 38 }, moto: { questions: 25, pass: 21 } },
  ...
  maine:          { car: { questions: 30, pass: 21 }, moto: { questions: 30, pass: 21 } },
  ...
  oklahoma:       { car: { questions: 25, pass: 20 }, moto: { questions: 25, pass: 20 } },
  oregon:         { car: { questions: 35, pass: 28 }, moto: { questions: 25, pass: 20 } },
  pennsylvania:   { car: { questions: 18, pass: 15 }, moto: { questions: 20, pass: 16 } },
  'rhode-island': { car: { questions: 25, pass: 20 }, moto: { questions: 25, pass: 20 } },
  ...
  utah:           { car: { questions: 25, pass: 20 }, moto: { questions: 25, pass: 20 } },
  vermont:        { car: { questions: 20, pass: 16 }, moto: { questions: 20, pass: 16 } },
  virginia:       { car: { questions: 25, pass: 20 }, moto: { questions: 25, pass: 20 } },
  washington:     { car: { questions: 25, pass: 20 }, moto: { questions: 25, pass: 20 } },
