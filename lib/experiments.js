...
export const EXPERIMENTS = {
  ...
  hero_copy: {
    status: 'running',
    description: 'Hero headline: v1 control / v2 uniqueness / v3 confidence',
    variants: { v1: 0.34, v2: 0.33, v3: 0.33 },
    // Read against the earliest high-volume step (test_visit). Purchase is too
    // sparse (~5/mo split 3 ways) to reach significance for a long time.
