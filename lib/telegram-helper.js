...
const MENU_LABELS = {
  en: {
    ...
    notary: '⚖️ Notary', translations: '🌍 Translations', contact: '💬 Message me', bugs: '🐛 Report bug',
  ...
  ru: {
    ...
    notary: '⚖️ Нотариус', translations: '🌍 Переводы', contact: '💬 Написать', bugs: '🐛 Сообщить о баге',
  ...
  ua: {
    ...
    notary: '⚖️ Нотаріус', translations: '🌍 Переклади', contact: '💬 Написати', bugs: '🐛 Повідомити про баг',
  ...
  es: {
    ...
    notary: '⚖️ Notario', translations: '🌍 Traducciones', contact: '💬 Escríbeme', bugs: '🐛 Reportar bug',
  ...
  zh: {
    ...
    notary: '⚖️ 公证', translations: '🌍 翻译', contact: '💬 联系我', bugs: '🐛 报告bug',
...
export function mainMenuKeyboard(lang) {
  ...
  // RU / UA / ES / ZH — full: Pricing, Manuals, Notary, Translations, Contact, Bugs + Site
  return {
    inline_keyboard: [
      [{ text: L(lang, 'pricing'), callback_data: 'menu:pricing' },
       { text: L(lang, 'manuals'), url: manualsUrl }],
      [{ text: L(lang, 'notary'), callback_data: 'action:notary' },
       { text: L(lang, 'translations'), callback_data: 'action:translations' }],
...
export const ACTION_PROMPTS = {
  en: {
    ...
    notary: '⚖️ <b>Notary services</b>\n\nDescribe what you need — apostille, certified copy, signature notarization. I\'ll connect you with a trusted partner.',
    translations: '🌍 <b>Translations</b>\n\nWhat needs translating? Document type + languages. My partner Anastasia handles this.',
  ...
  ru: {
    ...
    notary: '⚖️ <b>Нотариус</b>\n\nОпиши что нужно — апостиль, заверение копии, подпись. Соединю с проверенным партнёром.',
    translations: '🌍 <b>Переводы</b>\n\nЧто нужно перевести? Тип документа + языки. Передам Анастасии — она с этим работает.',
  ...
  ua: {
    ...
    notary: '⚖️ <b>Нотаріус</b>\n\nОпиши що потрібно — апостиль, завірення копії, підпис. З\'єднаю з перевіреним партнером.',
    translations: '🌍 <b>Переклади</b>\n\nЩо потрібно перекласти? Тип документа + мови. Передам Анастасії — вона з цим працює.',
  ...
  es: {
    ...
    notary: '⚖️ <b>Notario</b>\n\nDescribe lo que necesitas — apostilla, copia certificada, firma. Te conecto con un partner de confianza.',
    translations: '🌍 <b>Traducciones</b>\n\n¿Qué necesitas traducir? Tipo de documento + idiomas. Mi colega Anastasia se encarga.',
  ...
  zh: {
    ...
    notary: '⚖️ <b>公证</b>\n\n描述你需要的服务 — 认证、副本、签名公证。我会推荐可信赖的合作伙伴。',
    translations: '🌍 <b>翻译</b>\n\n需要翻译什么？文档类型 + 语言。Anastasia 会处理。',
