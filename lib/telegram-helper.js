...
// ── Inline keyboards ─────────────────────────────────────────────────────
const MENU_LABELS = {
  en: { pricing: '💰 Pricing', states: '🗽 States', languages: '🌍 Languages', refund: '💸 Refund', human: '🧑‍💻 Talk to founder', site: '🌐 Open dmvsos.com', back: '← Back to menu', states_all: '🇺🇸 All 50 states →', car: '🚗 Car / DMV', cdl: '🚛 CDL Pro', moto: '🏍️ Motorcycle', back_states: '← States' },
  ru: { pricing: '💰 Цены', states: '🗽 Штаты', languages: '🌍 Языки', refund: '💸 Возврат', human: '🧑‍💻 Связаться', site: '🌐 Открыть dmvsos.com', back: '← В меню', states_all: '🇺🇸 Все 50 штатов →', car: '🚗 Авто / DMV', cdl: '🚛 CDL Pro', moto: '🏍️ Мото', back_states: '← Штаты' },
  ua: { pricing: '💰 Ціни', states: '🗽 Штати', languages: '🌍 Мови', refund: '💸 Повернення', human: '🧑‍💻 Зв\'язатись', site: '🌐 Відкрити dmvsos.com', back: '← В меню', states_all: '🇺🇸 Усі 50 штатів →', car: '🚗 Авто / DMV', cdl: '🚛 CDL Pro', moto: '🏍️ Мото', back_states: '← Штати' },
  es: { pricing: '💰 Precios', states: '🗽 Estados', languages: '🌍 Idiomas', refund: '💸 Reembolso', human: '🧑‍💻 Contactar', site: '🌐 Abrir dmvsos.com', back: '← Volver', states_all: '🇺🇸 Los 50 estados →', car: '🚗 Auto / DMV', cdl: '🚛 CDL Pro', moto: '🏍️ Moto', back_states: '← Estados' },
  zh: { pricing: '💰 价格', states: '🗽 州', languages: '🌍 语言', refund: '💸 退款', human: '🧑‍💻 联系创始人', site: '🌐 打开 dmvsos.com', back: '← 返回', states_all: '🇺🇸 全部50个州 →', car: '🚗 汽车 / DMV', cdl: '🚛 CDL Pro', moto: '🏍️ 摩托', back_states: '← 州' },
};
...
export function mainMenuKeyboard(lang) {
  return {
    inline_keyboard: [
      [{ text: L(lang, 'pricing'), callback_data: 'menu:pricing' }, { text: L(lang, 'states'), callback_data: 'menu:states' }],
      [{ text: L(lang, 'languages'), callback_data: 'menu:languages' }, { text: L(lang, 'refund'), callback_data: 'menu:refund' }],
      [{ text: L(lang, 'human'), callback_data: 'menu:human' }],
      [{ text: L(lang, 'site'), url: `https://dmvsos.com?lang=${lang}` }],
    ],
  };
}
