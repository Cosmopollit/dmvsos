...
const MENU_LABELS = {
  en: {
    pricing: '💰 Pricing', manuals: '📚 Manuals', states: '🗽 States',
...
// Main menu inline keyboard. Service buttons (partnership/docs/contact/bugs)
// were removed when those routes were retired — they piled up zero usage in
// production and complicated the model. Users with questions just DM the
// bot directly; forwarding to admin still works.
export function mainMenuKeyboard(lang) {
  ...
  return {
    inline_keyboard: [
      ...
      [{ text: L(lang, 'states'), callback_data: 'menu:states' }],
