...
import { stateAnchor } from '@/lib/driving-schools';
...
export function buildServiceQuery(queryHead, stateSlug, lang) {
  ...
  // stateAnchor pins the query to the chosen state (not the user's current
  // location) and disambiguates Washington / New York / Georgia.
