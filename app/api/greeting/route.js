...
const GREETINGS = {
  ...
  'galynasemeniuk2806@gmail.com': {
    title: 'Вітаємо, Галино!',
    body: 'Auto Pass відкрито на 30 днів. Усі тести, усі режими, без обмежень. У тебе все вийде! Якщо будуть питання, напиши нам у підтримку. Удачі на іспиті!',
    cta: 'Поїхали',
  },
  'andusirbu1989@gmail.com': {
    title: 'Добро пожаловать, Sandu!',
