...
// Shared server-rendered body for the manuals library hub. `lang` arrives as a
// prop: the root wrapper passes the cookie language, the /[locale]/ wrapper
// passes the path-segment locale. This component reads NO cookies, so a
// cookieless crawler hitting /ru/manuals gets a genuinely Russian body. The
// manuals index is fetched here and runs identically for any language.
export default async function ManualsHubBody({ lang }) {
      ...
      <header className="w-full max-w-lg mx-auto pt-5 pb-4 px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <ManualsLangSwitcher currentLang={lang} />
          </div>
        </div>
      </header>
