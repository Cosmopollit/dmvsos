...
// Shared server-rendered body for the /dmv-test hub. `lang` arrives as a prop:
// the root wrapper passes the cookie language, the /[locale]/ wrapper passes
// the path-segment locale. This component reads NO cookies, so a cookieless
// crawler hitting /ru/dmv-test gets a genuinely Russian body. Strings are
// reused from lib/translations.js — no new copy.
export default function DmvTestHubBody({ lang }) {
